...
async def start(message: types.Message):
    ...
    Это означает, что после настройки и команды от пользователя
    Бот будет проверять раздел ПРАВИЛА ПРОДАЖИ БИЛЕТОВ 
    а именно
    График предварительной продажи билетов на ДЕКАБРЬ 2022 г. 

    По умолчанию бот ждет появления в графике продаж данных о спектакле Щелкунчик
    проверка происходит раз в 30 минут
